...
<body>
  ...
  <div class='choosecontent' id='gridcad'>
    ...
    <div class='btnuser'>
      <a href='cadastro_usuario.php'><button class='cadastraruser'>Começar</button></a>
    </div>
    ...
    <div class='btninst'>
      <a href='cadastro_inst.php'><button class='cadastraraltinst'>Cadastrar instituição</button></a>
    </div>
    <br>
    <br>
    <br>

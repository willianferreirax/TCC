...
if(isset($_REQUEST["validar"]) && $_REQUEST["validar"] == true){
	...
	if(isset($_POST['login_inst'])){
		...
		if(isset($_POST['nome_inst'])){
			$sql = "update faculdade set nome_inst = '$nome_inst'";
		}
	else if{
		if(isset($_POST['endereco_inst'])){
			$sql = "update faculdade set endereco_inst = '$endereco_inst'";
		}
	else if{
		if(isset($_POST['bairro_inst'])){
			$sql = "update faculdade set bairro_inst = '$bairro_inst'";
		}
	else if{
		if(isset($_POST['cidade_inst'])){
			$sql = "update faculdade set cidade_inst = '$cidade_inst'";
		}
	else if{
		if(isset($_POST['cep_inst'])){
			$sql = "update faculdade set cep_inst = '$cep_inst'";
		}
	else if{
		if(isset($_POST['email_inst'])){
			$sql = "update faculdade set email_inst = '$email_inst'";
		}
	else if{
		if(isset($_POST['telefone_inst"])){
			$sql = "update faculdade set telefone_inst = '$telefone_inst'";

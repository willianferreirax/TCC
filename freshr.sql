...
--
-- Host: 127.0.0.1
-- Generation Time: 17-Nov-2019 às 21:12
...
(1, 3, 4, 'Gostei do evento.'),
(2, 10, 4, 'Inovador!'),
(3, 9, 4, 'Da maneira como foi descrito.'),
(4, 3, 4, 'Ã‰pico'),
(5, 3, 4, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas luctus, justo sed accumsan vulputate, dolor nunc iaculis elit, in tincidunt massa nunc et turpis. Suspendisse nec convallis massa. Proin bibendum nunc turpis, feugiat maximus nisl consectetur ac. Donec quis mauris vitae nisl aliquet scelerisque non ac turpis. Nam a vestibulum felis. Curabitur urna nisl, pulvinar non egestas ac, sodales nec justo. Morbi dapibus ex quam, vel iaculis eros ult');
...
CREATE TABLE `evento` (
  ...
  `detalhes_evento` varchar(500) NOT NULL,
...
(4, 'Feira TecnolÃ³gica 2019', '09dd3bf35a28acfa233def75b252875f.jpg', '2019-10-17', '2019-10-19', '07:50:00', '15:30:00', 'Avenida Ãguia de Haia, 2366', 'C.A.E Carvalho', 'SÃ£o Paulo', 'SP', '08220-010', 1, 'A Feira TecnolÃ³gica da ETEC Zona Leste apresenta as mais diversas tecnologias presentes no mercado de trabalho hoje. Venha e conheÃ§a!', '', '0', 1002, '124', 124, '11111111111'),
...
(5, 'InformaÃ§Ã£o e Tecnologia', NULL, NULL, NULL, NULL, 9),
(6, 'MÃºsica', NULL, NULL, NULL, NULL, 10);
...
(3, 'Lucas', 'Campanelli', 'lucasoucam@hotmail.com', '25d55ad283aa400af464c76d713c07ad', 'campa'),
...
(9, 'Willian', 'Ferreira', 'will@email.com', '25d55ad283aa400af464c76d713c07ad', 'will'),
(10, 'Nicholas', 'Campanelli', 'nicholas@email.com', '25d55ad283aa400af464c76d713c07ad', 'nicc');
...
--
ALTER TABLE `avaliacao`
  MODIFY `cod_media` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `comparecimento`
  MODIFY `cod_comp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `interessado`
  MODIFY `cod_interessado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `interesses_usuario`
  MODIFY `cod_interesseusu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `usuario`
  MODIFY `cod_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;COMMIT;
